...
public class BasicTelecomProjectApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        customerRepository.save(new Customer("Jack", "Italy",new SimpleDateFormat("yyyy-MM-dd").parse("2000-04-28")));
        customerRepository.save(new Customer("Adam", "US", new SimpleDateFormat("yyyy-MM-dd").parse("1970-04-28")));
        customerRepository.save(new Customer("Harry", "Italy",new SimpleDateFormat("yyyy-MM-dd").parse("1990-05-05")));
        customerRepository.save(new Customer("David", "Japan", new SimpleDateFormat("yyyy-MM-dd").parse("1970-05-28")));
        customerRepository.save(new Customer("Peter", "Canada",new SimpleDateFormat("yyyy-MM-dd").parse("1980-05-05")));
